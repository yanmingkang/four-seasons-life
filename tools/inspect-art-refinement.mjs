...
const root=new URL('../',import.meta.url),out=new URL('../test-results/art-refinement/',import.meta.url);
...
try{
  ...
  for(const [view,cells] of [['building',[1,3,14,29,38,40]],['scene',[6,15,18,25,27]]])for(const cell of cells){
